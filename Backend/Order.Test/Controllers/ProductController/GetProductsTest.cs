...
{
    /// <summary>
    /// Tests for getting products for end users.
    /// </summary>
    [TestClass]
    public class GetProductsTest : BaseTest
    {
        /// <summary>
        ...
        public async Task Success()
        {
            ...
            Assert.AreEqual("Light", products[0].Images[0].Name);
            StringAssert.StartsWith(products[0].Images[0].File, "/images/");
            CollectionAssert.AreEqual(Util.GetImage(FileType.Light), await _client.Download(products[0].Images[0].File));
        }
