...
import { ClosedSpecificationValue, useAddOverwriteClosedSpecification, useRenameClosedSpecification } from "../../hooks/APIHook";
...
export const RenameClosedSpecification = (props: Props) => {
    ...
    const {isLoading: isLoadingRename, isSuccess: isSuccessRename, error: errorRename} = useRenameClosedSpecification(
        state.category,
        state.oldName,
        state.formData.name,
        state.disabled && !state.new
    );
    const {isLoading: isLoadingNew, isSuccess: isSuccessNew, error: errorNew} = useAddOverwriteClosedSpecification(
        state.category,
        state.formData.name,
        state.filter,
        false,
