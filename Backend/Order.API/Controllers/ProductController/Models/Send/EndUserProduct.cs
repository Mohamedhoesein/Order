namespace Order.API.Controllers.ProductController.Models.Send
{
    ...
    public class EndUserProduct
    {
        ...
        /// <summary>
        /// Initialize a new empty <see cref="EndUserProduct"/>.
        /// </summary>
        public EndUserProduct() {}

        /// <summary>
        /// Initialize a new <see cref="EndUserProduct"/> based on a <see cref="Context.Product"/>.
        /// </summary>
        /// <param name="product">
        ...
        /// </exception>
        public EndUserProduct(Context.Product product)
        {
            ...
            OpenSpecificationValues = latestVersion.OpenSpecificationValues
                ...
                .ToArray();
            Images = latestVersion.ProductImages
