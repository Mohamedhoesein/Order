    ...
    public class GetProductsEmployeeTest : BaseTest
    {
        ...
        public async Task Success()
        {
            ...
            var getProductsEmployeeResult =
                await _client.GetEmployeeProducts("TestCategory");
        ...
        public async Task Success_Updated()
        {
            ...
            var a = await updateProductResult1.Content.ReadAsStringAsync();
        ...
        public async Task Error_CategoryNotFound()
        {
            ...
            var getProductResult = await _client.GetEmployeeProducts("TEST");
